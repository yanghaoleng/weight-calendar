...
messages["zh-HK"] = {
  ...
  storedData: "會記錄什麼", storedAccount: "帳戶資料：4 位或 6 位密碼的安全雜湊值與加密副本、手機號碼後四位的安全雜湊值、選填暱稱、顯示與語言偏好、選填身高和估算體脂率。", storedRecords: "記錄資料：你主動填寫的日期、體重以及更新時間。", storedTechnical: "必要技術資料：連線標識、造訪時間、路徑、IP 地址及其粗略地區和網絡資訊、瀏覽器資訊，用於登入、安全和基本營運統計。", storedAi: "AI 資料：只在你主動點擊分析時，將身高、估算體脂率和近期體重摘要傳送給豆包模型產生建議。",
...
messages["zh-TW"] = {
  ...
  storedAccount: "帳號資料：4 位或 6 位密碼的安全雜湊值與加密副本、手機號碼後四位的安全雜湊值、選填暱稱、顯示、語言與體重單位偏好、選填身高和估算體脂率。", storedTechnical: "必要技術資料：連線識別、瀏覽時間、路徑、IP 位址及其粗略地區和網路資訊、瀏覽器資訊，用於登入、安全和基本營運統計。",
