...
Object.assign(messages["zh-HK"], {
  ...
  storedAccount: "帳戶資料：4 位或 6 位密碼的安全雜湊值與加密副本、手機號碼後四位的安全雜湊值、選填暱稱、顯示、語言與體重單位偏好、選填身高和估算體脂率。",
...
Object.assign(messages["zh-TW"], {
  ...
  storedAccount: "帳號資料：4 位或 6 位密碼的安全雜湊值與加密副本、手機號碼後四位的安全雜湊值、選填暱稱、顯示、語言與體重單位偏好、選填身高和估算體脂率。",
  newPasscodeIntro: "請輸入新的 4 位或 6 位數字密碼。",
});
