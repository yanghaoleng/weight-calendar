...
const messages = {
  "zh-CN": {
    ...
    data: "数据",
    exportData: "导出数据",
    exportHint: "下载含 Markdown 和 HTML 的导出包（{count} 条记录）",
    support: "支持",
    donateAuthor: "打赏作者",
...
messages["zh-HK"] = {
  ...
  data: "資料", exportData: "匯出資料", exportHint: "下載含 Markdown 和 HTML 的匯出包（{count} 條記錄）", support: "支持", account: "帳戶", logout: "登出", deleteAccount: "註銷帳戶",
